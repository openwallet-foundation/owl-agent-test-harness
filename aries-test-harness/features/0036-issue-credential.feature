Feature: RFC 0036 Aries agent issue credential
  ...
  @T001-RFC0036 @AIP10 @RFC0036 @critical @AcceptanceTest @Indy
  ...
  @T001.1-RFC0036 @AIP10 @RFC0036 @critical @AcceptanceTest @Indy @DIDExchangeConnection
  ...
  @T002-RFC0036 @AIP10 @RFC0036 @normal @AcceptanceTest @Indy
  ...
  @T003-RFC0036 @AIP10 @RFC0036 @critical @AcceptanceTest @Indy
  ...
  @T004-RFC0036 @AIP10 @RFC0036 @normal @AcceptanceTest @Indy
  ...
  @T005-RFC0036 @AIP10 @RFC0036 @minor @wip @AcceptanceTest
  ...
  @T006-RFC0036 @AIP10 @RFC0036 @critical @wip @AcceptanceTest
