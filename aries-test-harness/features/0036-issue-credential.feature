Feature: RFC 0036 Aries agent issue credential
  ...
  @T001-RFC0036 @AcceptanceTest @AIP10 @critical @Indy @RFC0036
  ...
  @T001.1-RFC0036 @AcceptanceTest @AIP10 @critical @Indy @RFC0036 @DIDExchangeConnection
  ...
  @T002-RFC0036 @AcceptanceTest @AIP10 @normal @Indy @RFC0036
  ...
  @T003-RFC0036 @AcceptanceTest @AIP10 @critical @Indy @RFC0036
  ...
  @T004-RFC0036 @AcceptanceTest @AIP10 @Indy @normal @RFC0036
  ...
  @T005-RFC0036 @wip @AcceptanceTest @AIP10 @minor @RFC0036
  ...
  @T006-RFC0036 @wip @AcceptanceTest @AIP10 @critical @RFC0036
