...
Feature: RFC 0036 Aries agent issue credential
  ...
  @T001-RFC0036 @AIP10 @critical @AcceptanceTest @Indy @CredProposalV1Start
  ...
  @T001.1-RFC0036 @AIP20 @critical @AcceptanceTest @Indy @DIDExchangeConnection @CredProposalV1Start
  ...
  @T002-RFC0036 @AIP10 @normal @AcceptanceTest @Indy @CredProposalV1Start
  ...
  @T004-RFC0036 @AIP10 @normal @AcceptanceTest @Indy @CredProposalV1Start
  ...
  @T005-RFC0036 @AIP10 @minor @wip @AcceptanceTest @CredProposalV1Start
