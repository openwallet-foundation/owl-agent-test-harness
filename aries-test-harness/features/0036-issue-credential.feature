Feature: Aries agent issue credential functions RFC 0036
  ...
  @T001-AIP10-RFC0036 @AcceptanceTest @P1 @critical @Indy
  ...
  @T002-AIP10-RFC0036 @AcceptanceTest @P2 @normal @Indy
  ...
  @T003-AIP10-RFC0036 @AcceptanceTest @P1 @critical @Indy
  ...
  @T004-AIP10-RFC0036 @AcceptanceTest @P2 @normal @Indy
  ...
  @T005-AIP10-RFC0036 @wip @AcceptanceTest @P3 @minor
  ...
  @T006-AIP10-RFC0036 @wip @AcceptanceTest @P1 @critical
