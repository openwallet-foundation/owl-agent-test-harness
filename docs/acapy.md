...
| [acapy-afj](#runset-acapy-afj) | acapy-main<br>1.0.0-rc1 | javascript<br>0.3.3-alpha.12 | acapy-main<br>1.0.0-rc1 | acapy-main<br>1.0.0-rc1 | AIP 1.0 | [**38 / 39<br>97%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
...
| [acapy-aip20](#runset-acapy-aip20) | acapy-main<br>1.0.0-rc1 | acapy-main<br>1.0.0-rc1 | acapy-main<br>1.0.0-rc1 | acapy-main<br>1.0.0-rc1 | AIP 2.0 | [**60 / 61<br>98%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-aip20/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-ariesvcx](#runset-acapy-ariesvcx) | acapy-main<br>1.0.0-rc1 | aries-vcx<br>1.0.0 | acapy-main<br>1.0.0-rc1 | acapy-main<br>1.0.0-rc1 | AIP 1.0 | [**5 / 18<br>27%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-aries-vcx/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-dotnet-javascript](#runset-acapy-dotnet-javascript) | acapy-main<br>1.0.0-rc1 | javascript<br>0.3.3-alpha.12 | dotnet<br> | acapy-main<br>1.0.0-rc1 | AIP 1.0 | [**12 / 12<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-javascript-f-dotnet/reports/latest/index.html?redirect=false#behaviors) |
...
| [acapy-findy](#runset-acapy-findy) | acapy-main<br>1.0.0-rc1 | findy<br>0.30.49 | acapy-main<br>1.0.0-rc1 | acapy-main<br>1.0.0-rc1 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-findy/reports/latest/index.html?redirect=false#behaviors) |
...
| [afj-acapy](#runset-afj-acapy) | javascript<br>0.3.3-alpha.12 | acapy-main<br>1.0.0-rc1 | javascript<br>0.3.3-alpha.12 | javascript<br>0.3.3-alpha.12 | AIP 1.0 | [**27 / 28<br>96%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
| [ariesvcx-acapy](#runset-ariesvcx-acapy) | aries-vcx<br>1.0.0 | acapy-main<br>1.0.0-rc1 | aries-vcx<br>1.0.0 | aries-vcx<br>1.0.0 | AIP 1.0 | [**0 / 20<br>0%**](https://allure.vonx.io/api/allure-docker-service/projects/aries-vcx-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
| [findy-acapy](#runset-findy-acapy) | findy<br>0.30.49 | acapy-main<br>1.0.0-rc1 | findy<br>0.30.49 | findy<br>0.30.49 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
*Last run: Thu Jan 19 00:34:32 UTC 2023*
```
...
*Last run: Thu Jan 19 00:54:55 UTC 2023*
```
...
*Last run: Thu Jan 19 00:44:17 UTC 2023*
```
...
*Last run: Thu Jan 19 00:58:17 UTC 2023*
```
...
*Last run: Thu Jan 19 01:16:27 UTC 2023*
```
...
*Last run: Thu Jan 19 01:03:19 UTC 2023*
```
...
*Last run: Thu Jan 19 01:09:29 UTC 2023*
```
...
*Last run: Thu Jan 19 01:15:51 UTC 2023*
```
...
*Last run: Thu Jan 19 01:09:37 UTC 2023*
```
...
*Last run: Thu Jan 19 01:26:11 UTC 2023*
```
...
*Last run: Thu Jan 19 01:38:20 UTC 2023*
```
...
*Last run: Thu Jan 19 02:17:43 UTC 2023*
```
...
*Last run: Thu Jan 19 02:24:58 UTC 2023*
```
...
*Last run: Thu Jan 19 02:45:02 UTC 2023*
```
