...
| ------ | :--------------: | :-------------: | :----------------: | :-----------------: | ----- | :-----: | 
| [acapy-afgo](#runset-acapy-afgo) | acapy-main<br>1.0.0-rc0 | afgo-interop<br>unknown | acapy-main<br>1.0.0-rc0 | acapy-main<br>1.0.0-rc0 | pre-AIP 2.0 | [**5 / 14<br>35%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-afgo/reports/latest/index.html?redirect=false#behaviors) |
...
| [acapy-findy](#runset-acapy-findy) | acapy-main<br>1.0.0-rc0 | findy<br>0.30.30 | acapy-main<br>1.0.0-rc0 | acapy-main<br>1.0.0-rc0 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-findy/reports/latest/index.html?redirect=false#behaviors) |
...
| [afgo-acapy](#runset-afgo-acapy) | afgo-interop<br>unknown | acapy-main<br>1.0.0-rc0 | afgo-interop<br>unknown | afgo-interop<br>unknown | pre-AIP 2.0 | [**15 / 17<br>88%**](https://allure.vonx.io/api/allure-docker-service/projects/afgo-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
| [ariesvcx-acapy](#runset-ariesvcx-acapy) | aries-vcx<br>1.0.0 | acapy-main<br>1.0.0-rc0 | aries-vcx<br>1.0.0 | aries-vcx<br>1.0.0 | AIP 1.0 | [**19 / 20<br>95%**](https://allure.vonx.io/api/allure-docker-service/projects/aries-vcx-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
| [findy-acapy](#runset-findy-acapy) | findy<br>0.30.30 | acapy-main<br>1.0.0-rc0 | findy<br>0.30.30 | findy<br>0.30.30 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
```tip
**Latest results: 5 out of 14 (35%)**


*Last run: Wed Aug 31 02:45:52 UTC 2022*
```
...
*Last run: Wed Aug 31 02:56:09 UTC 2022*
```
...
*Last run: Wed Aug 31 03:07:24 UTC 2022*
```
...
*Last run: Wed Aug 31 03:28:11 UTC 2022*
```
...
*Last run: Wed Aug 31 03:21:25 UTC 2022*
```
...
*Last run: Wed Aug 31 03:27:51 UTC 2022*
```
...
*Last run: Wed Aug 31 03:26:08 UTC 2022*
```
...
*Last run: Wed Aug 31 03:46:51 UTC 2022*
```
...
*Last run: Wed Aug 31 04:36:59 UTC 2022*
```
...
*Last run: Wed Aug 31 04:24:08 UTC 2022*
```
...
*Last run: Wed Aug 31 04:54:28 UTC 2022*
```
