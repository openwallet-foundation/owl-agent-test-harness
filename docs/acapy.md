...
| ------ | :--------------: | :-------------: | :----------------: | :-----------------: | ----- | :-----: | 
| [acapy-afgo](#runset-acapy-afgo) | acapy-main<br>0.7.3 | afgo-interop<br>unknown | acapy-main<br>0.7.3 | acapy-main<br>0.7.3 | pre-AIP 2.0 | [**11 / 12<br>91%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-afgo/reports/latest/index.html?redirect=false#behaviors) |
...
| [acapy-ariesvcx](#runset-acapy-ariesvcx) | acapy-main<br>0.7.3 | aries-vcx<br>1.0.0 | acapy-main<br>0.7.3 | acapy-main<br>0.7.3 | AIP 1.0 | [**19 / 35<br>54%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-aries-vcx/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-findy](#runset-acapy-findy) | acapy-main<br>0.7.3 | findy<br>0.30.0 | acapy-main<br>0.7.3 | acapy-main<br>0.7.3 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-findy/reports/latest/index.html?redirect=false#behaviors) |
...
| [afgo-acapy](#runset-afgo-acapy) | afgo-interop<br>unknown | acapy-main<br>0.7.3 | afgo-interop<br>unknown | afgo-interop<br>unknown | pre-AIP 2.0 | [**10 / 12<br>83%**](https://allure.vonx.io/api/allure-docker-service/projects/afgo-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
| [findy-acapy](#runset-findy-acapy) | findy<br>0.30.0 | acapy-main<br>0.7.3 | findy<br>0.30.0 | findy<br>0.30.0 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
*Last run: Thu Mar 17 01:52:23 UTC 2022*
```
...
*Last run: Thu Mar 17 02:09:43 UTC 2022*
```
...
*Last run: Thu Mar 17 02:04:45 UTC 2022*
```
...
*Last run: Thu Mar 17 02:24:55 UTC 2022*
```
...
```tip
**Latest results: 19 out of 35 (54%)**


*Last run: Wed Mar 16 03:15:01 UTC 2022*
```
...
*Last run: Thu Mar 17 02:41:42 UTC 2022*
```
...
*Last run: Thu Mar 17 02:41:59 UTC 2022*
```
...
*Last run: Thu Mar 17 02:15:34 UTC 2022*
```
...
*Last run: Thu Mar 17 02:26:36 UTC 2022*
```
...
*Last run: Thu Mar 17 03:01:19 UTC 2022*
```
...
*Last run: Thu Mar 17 02:41:57 UTC 2022*
```
