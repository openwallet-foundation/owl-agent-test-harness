...
| [acapy-afj](#runset-acapy-afj) | acapy-main<br>0.8.2 | javascript<br>0.4.1-alpha.6 | acapy-main<br>0.8.2 | acapy-main<br>0.8.2 | AIP 1.0 | [**38 / 39<br>97%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-aip10](#runset-acapy-aip10) | acapy-main<br>0.8.2 | acapy-main<br>0.8.2 | acapy-main<br>0.8.2 | acapy-main<br>0.8.2 | AIP 1.0 | [**35 / 35<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-aip10/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-aip20](#runset-acapy-aip20) | acapy-main<br>0.8.2 | acapy-main<br>0.8.2 | acapy-main<br>0.8.2 | acapy-main<br>0.8.2 | AIP 2.0 | [**60 / 61<br>98%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-aip20/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-ariesvcx](#runset-acapy-ariesvcx) | acapy-main<br>0.8.2 | aries-vcx<br>1.0.0 | acapy-main<br>0.8.2 | acapy-main<br>0.8.2 | AIP 1.0 | [**18 / 18<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-aries-vcx/reports/latest/index.html?redirect=false#behaviors) |
...
| [afj-acapy](#runset-afj-acapy) | javascript<br>0.4.1-alpha.6 | acapy-main<br>0.8.2 | javascript<br>0.4.1-alpha.6 | javascript<br>0.4.1-alpha.6 | AIP 1.0 | [**11 / 28<br>39%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
| [ariesvcx-acapy](#runset-ariesvcx-acapy) | aries-vcx<br>1.0.0 | acapy-main<br>0.8.2 | aries-vcx<br>1.0.0 | aries-vcx<br>1.0.0 | AIP 1.0 | [**19 / 20<br>95%**](https://allure.vonx.io/api/allure-docker-service/projects/aries-vcx-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
*Last run: Mon Jul 17 00:26:57 UTC 2023*
```
...
*Last run: Mon Jul 17 00:52:02 UTC 2023*
```
...
*Last run: Mon Jul 17 00:39:56 UTC 2023*
```
...
*Last run: Mon Jul 17 00:50:06 UTC 2023*
```
...
*Last run: Mon Jul 17 01:14:19 UTC 2023*
```
...
*Last run: Mon Jul 17 01:08:40 UTC 2023*
```
...
*Last run: Mon Jul 17 01:11:11 UTC 2023*
```
...
*Last run: Mon Jul 17 01:26:10 UTC 2023*
```
...
*Last run: Mon Jul 17 02:18:19 UTC 2023*
```
...
*Last run: Mon Jul 17 02:17:50 UTC 2023*
```
