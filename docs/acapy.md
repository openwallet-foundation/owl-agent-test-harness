...
| ------ | :--------------: | :-------------: | :----------------: | :-----------------: | ----- | :-----: | 
| [acapy-afgo](#runset-acapy-afgo) | acapy-main<br>0.8.0 | afgo-interop<br>unknown | acapy-main<br>0.8.0 | acapy-main<br>0.8.0 | pre-AIP 2.0 | [**3 / 14<br>21%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-afgo/reports/latest/index.html?redirect=false#behaviors) |
...
| [acapy-aip10](#runset-acapy-aip10) | acapy-main<br>0.8.0 | acapy-main<br>0.8.0 | acapy-main<br>0.8.0 | acapy-main<br>0.8.0 | AIP 1.0 | [**35 / 35<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-aip10/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-aip20](#runset-acapy-aip20) | acapy-main<br>0.8.0 | acapy-main<br>0.8.0 | acapy-main<br>0.8.0 | acapy-main<br>0.8.0 | AIP 2.0 | [**60 / 61<br>98%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-aip20/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-ariesvcx](#runset-acapy-ariesvcx) | acapy-main<br>0.8.0 | aries-vcx<br>1.0.0 | acapy-main<br>0.8.0 | acapy-main<br>0.8.0 | AIP 1.0 | [**18 / 18<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-aries-vcx/reports/latest/index.html?redirect=false#behaviors) |
...
| [acapy-findy](#runset-acapy-findy) | acapy-main<br>0.8.0 | findy<br>0.30.58 | acapy-main<br>0.8.0 | acapy-main<br>0.8.0 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-findy/reports/latest/index.html?redirect=false#behaviors) |
| [afgo-acapy](#runset-afgo-acapy) | afgo-interop<br>unknown | acapy-main<br>0.8.0 | afgo-interop<br>unknown | afgo-interop<br>unknown | pre-AIP 2.0 | [**1 / 17<br>5%**](https://allure.vonx.io/api/allure-docker-service/projects/afgo-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
| [ariesvcx-acapy](#runset-ariesvcx-acapy) | aries-vcx<br>1.0.0 | acapy-main<br>0.8.0 | aries-vcx<br>1.0.0 | aries-vcx<br>1.0.0 | AIP 1.0 | [**16 / 20<br>80%**](https://allure.vonx.io/api/allure-docker-service/projects/aries-vcx-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
| [findy-acapy](#runset-findy-acapy) | findy<br>0.30.58 | acapy-main<br>0.8.0 | findy<br>0.30.58 | findy<br>0.30.58 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
*Last run: Wed Mar 22 04:58:02 UTC 2023*
```
...
*Last run: Wed Mar 22 05:12:47 UTC 2023*
```
...
*Last run: Wed Mar 22 05:22:17 UTC 2023*
```
...
*Last run: Wed Mar 22 05:45:11 UTC 2023*
```
...
*Last run: Wed Mar 22 05:34:53 UTC 2023*
```
...
*Last run: Wed Mar 22 05:39:25 UTC 2023*
```
...
*Last run: Wed Mar 22 11:23:59 UTC 2023*
```
...
*Last run: Wed Mar 22 15:27:07 UTC 2023*
```
...
*Last run: Wed Mar 22 18:59:18 UTC 2023*
```
...
*Last run: Wed Mar 22 19:38:52 UTC 2023*
```
