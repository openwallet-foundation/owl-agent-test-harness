...
| [afj-acapy](#runset-afj-acapy) | javascript<br>0.1.0-alpha.233 | acapy-main<br>0.7.1 | javascript<br>0.1.0-alpha.233 | javascript<br>0.1.0-alpha.233 | AIP 1.0 | [**14 / 17<br>82%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
*Last run: Fri Sep 24 01:32:23 UTC 2021*
```
...
*Last run: Fri Sep 24 01:35:29 UTC 2021*
```
...
*Last run: Fri Sep 24 01:48:38 UTC 2021*
```
...
*Last run: Fri Sep 24 01:40:27 UTC 2021*
```
...
*Last run: Fri Sep 24 01:57:10 UTC 2021*
```
...
*Last run: Fri Sep 24 02:12:29 UTC 2021*
```
...
*Last run: Fri Sep 24 02:20:26 UTC 2021*
```
...
*Last run: Fri Sep 24 02:07:51 UTC 2021*
```
