...
| [acapy-findy](#runset-acapy-findy) | acapy-main<br>0.12.0rc0 | findy<br>0.31.50 | acapy-main<br>0.12.0rc0 | acapy-main<br>0.12.0rc0 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-findy/reports/latest/index.html?redirect=false#behaviors) |
...
| [ariesvcx-acapy](#runset-ariesvcx-acapy) | aries-vcx<br>1.0.0 | acapy-main<br>0.12.0rc0 | aries-vcx<br>1.0.0 | aries-vcx<br>1.0.0 | AIP 1.0 | [**19 / 20<br>95%**](https://allure.vonx.io/api/allure-docker-service/projects/aries-vcx-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
| [findy-acapy](#runset-findy-acapy) | findy<br>0.31.50 | acapy-main<br>0.12.0rc0 | findy<br>0.31.50 | findy<br>0.31.50 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
*Last run: Wed Jan 24 00:21:05 UTC 2024*
```
...
*Last run: Wed Jan 24 00:34:35 UTC 2024*
```
...
*Last run: Wed Jan 24 00:45:01 UTC 2024*
```
...
*Last run: Wed Jan 24 00:56:28 UTC 2024*
```
...
*Last run: Wed Jan 24 00:49:33 UTC 2024*
```
...
*Last run: Wed Jan 24 01:00:59 UTC 2024*
```
...
*Last run: Wed Jan 24 01:02:55 UTC 2024*
```
...
*Last run: Wed Jan 24 01:52:37 UTC 2024*
```
...
*Last run: Wed Jan 24 01:35:06 UTC 2024*
```
...
*Last run: Wed Jan 24 02:05:10 UTC 2024*
```
