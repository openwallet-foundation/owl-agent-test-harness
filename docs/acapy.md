...
| [acapy-afj](#runset-acapy-afj) | acapy-main<br>1.0.0-rc1 | javascript<br>0.3.3-alpha.0 | acapy-main<br>1.0.0-rc1 | acapy-main<br>1.0.0-rc1 | AIP 1.0 | [**38 / 39<br>97%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
...
| [acapy-dotnet-javascript](#runset-acapy-dotnet-javascript) | acapy-main<br>1.0.0-rc1 | javascript<br>0.3.3-alpha.0 | dotnet<br> | acapy-main<br>1.0.0-rc1 | AIP 1.0 | [**12 / 12<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-javascript-f-dotnet/reports/latest/index.html?redirect=false#behaviors) |
...
| [acapy-findy](#runset-acapy-findy) | acapy-main<br>1.0.0-rc1 | findy<br>0.30.47 | acapy-main<br>1.0.0-rc1 | acapy-main<br>1.0.0-rc1 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-findy/reports/latest/index.html?redirect=false#behaviors) |
...
| [afj-acapy](#runset-afj-acapy) | javascript<br>0.3.3-alpha.0 | acapy-main<br>1.0.0-rc1 | javascript<br>0.3.3-alpha.0 | javascript<br>0.3.3-alpha.0 | AIP 1.0 | [**27 / 28<br>96%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
| [findy-acapy](#runset-findy-acapy) | findy<br>0.30.47 | acapy-main<br>1.0.0-rc1 | findy<br>0.30.47 | findy<br>0.30.47 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
*Last run: Tue Jan 10 00:34:05 UTC 2023*
```
...
*Last run: Tue Jan 10 00:56:31 UTC 2023*
```
...
*Last run: Tue Jan 10 00:51:00 UTC 2023*
```
...
*Last run: Tue Jan 10 00:58:23 UTC 2023*
```
...
*Last run: Tue Jan 10 01:16:19 UTC 2023*
```
...
*Last run: Tue Jan 10 01:13:33 UTC 2023*
```
...
*Last run: Tue Jan 10 01:10:10 UTC 2023*
```
...
*Last run: Tue Jan 10 01:14:57 UTC 2023*
```
...
*Last run: Tue Jan 10 01:19:32 UTC 2023*
```
...
*Last run: Tue Jan 10 01:30:00 UTC 2023*
```
...
*Last run: Tue Jan 10 01:40:55 UTC 2023*
```
...
*Last run: Tue Jan 10 02:17:34 UTC 2023*
```
...
*Last run: Tue Jan 10 02:27:17 UTC 2023*
```
...
*Last run: Tue Jan 10 02:54:28 UTC 2023*
```
