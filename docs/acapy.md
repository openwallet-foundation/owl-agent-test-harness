...
| ------ | :--------------: | :-------------: | :----------------: | :-----------------: | ----- | :-----: | 
| [acapy-afgo](#runset-acapy-afgo) | acapy-main<br>0.9.0-rc0 | afgo-interop<br>unknown | acapy-main<br>0.9.0-rc0 | acapy-main<br>0.9.0-rc0 | pre-AIP 2.0 | [**3 / 14<br>21%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-afgo/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-afj](#runset-acapy-afj) | acapy-main<br>0.9.0-rc0 | javascript<br>0.4.1-alpha.9 | acapy-main<br>0.9.0-rc0 | acapy-main<br>0.9.0-rc0 | AIP 1.0 | [**38 / 39<br>97%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-aip10](#runset-acapy-aip10) | acapy-main<br>0.9.0-rc0 | acapy-main<br>0.9.0-rc0 | acapy-main<br>0.9.0-rc0 | acapy-main<br>0.9.0-rc0 | AIP 1.0 | [**35 / 35<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-aip10/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-aip20](#runset-acapy-aip20) | acapy-main<br>0.9.0-rc0 | acapy-main<br>0.9.0-rc0 | acapy-main<br>0.9.0-rc0 | acapy-main<br>0.9.0-rc0 | AIP 2.0 | [**60 / 61<br>98%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-aip20/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-ariesvcx](#runset-acapy-ariesvcx) | acapy-main<br>0.9.0-rc0 | aries-vcx<br>1.0.0 | acapy-main<br>0.9.0-rc0 | acapy-main<br>0.9.0-rc0 | AIP 1.0 | [**18 / 18<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-aries-vcx/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-dotnet-javascript](#runset-acapy-dotnet-javascript) | acapy-main<br>0.9.0-rc0 | javascript<br>0.4.1-alpha.9 | dotnet<br> | acapy-main<br>0.9.0-rc0 | AIP 1.0 | [**6 / 12<br>50%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-javascript-f-dotnet/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-dotnet](#runset-acapy-dotnet) | acapy-main<br>0.9.0-rc0 | dotnet<br> | acapy-main<br>0.9.0-rc0 | acapy-main<br>0.9.0-rc0 | AIP 1.0 | [**0 / 12<br>0%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-dotnet/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-findy](#runset-acapy-findy) | acapy-main<br>0.9.0-rc0 | findy<br>0.31.11 | acapy-main<br>0.9.0-rc0 | acapy-main<br>0.9.0-rc0 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-findy/reports/latest/index.html?redirect=false#behaviors) |
| [afgo-acapy](#runset-afgo-acapy) | afgo-interop<br>unknown | acapy-main<br>0.9.0-rc0 | afgo-interop<br>unknown | afgo-interop<br>unknown | pre-AIP 2.0 | [**1 / 17<br>5%**](https://allure.vonx.io/api/allure-docker-service/projects/afgo-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
| [afj-acapy](#runset-afj-acapy) | javascript<br>0.4.1-alpha.9 | acapy-main<br>0.9.0-rc0 | javascript<br>0.4.1-alpha.9 | javascript<br>0.4.1-alpha.9 | AIP 1.0 | [**11 / 28<br>39%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
| [ariesvcx-acapy](#runset-ariesvcx-acapy) | aries-vcx<br>1.0.0 | acapy-main<br>0.9.0-rc0 | aries-vcx<br>1.0.0 | aries-vcx<br>1.0.0 | AIP 1.0 | [**19 / 20<br>95%**](https://allure.vonx.io/api/allure-docker-service/projects/aries-vcx-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
| [dotnet-acapy](#runset-dotnet-acapy) | dotnet<br> | acapy-main<br>0.9.0-rc0 | dotnet<br> | dotnet<br> | AIP 1.0 | [**0 / 12<br>0%**](https://allure.vonx.io/api/allure-docker-service/projects/dotnet-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
| [findy-acapy](#runset-findy-acapy) | findy<br>0.31.11 | acapy-main<br>0.9.0-rc0 | findy<br>0.31.11 | findy<br>0.31.11 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
*Last run: Sat Jul 22 00:23:28 UTC 2023*
```
...
*Last run: Sat Jul 22 00:46:17 UTC 2023*
```
...
*Last run: Sat Jul 22 00:36:31 UTC 2023*
```
...
*Last run: Sat Jul 22 00:49:10 UTC 2023*
```
...
*Last run: Sat Jul 22 01:24:03 UTC 2023*
```
...
*Last run: Sat Jul 22 00:50:00 UTC 2023*
```
...
*Last run: Sat Jul 22 00:53:30 UTC 2023*
```
...
*Last run: Sat Jul 22 01:05:49 UTC 2023*
```
...
*Last run: Sat Jul 22 01:10:08 UTC 2023*
```
...
*Last run: Sat Jul 22 01:25:50 UTC 2023*
```
...
*Last run: Sat Jul 22 02:30:56 UTC 2023*
```
...
*Last run: Sat Jul 22 01:59:21 UTC 2023*
```
...
*Last run: Sat Jul 22 02:36:36 UTC 2023*
```
