...
| ------ | :--------------: | :-------------: | :----------------: | :-----------------: | ----- | :-----: | 
| [acapy-afgo](#runset-acapy-afgo) | acapy-main<br>0.8.1-rc2 | afgo-interop<br>unknown | acapy-main<br>0.8.1-rc2 | acapy-main<br>0.8.1-rc2 | pre-AIP 2.0 | [**3 / 14<br>21%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-afgo/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-afj](#runset-acapy-afj) | acapy-main<br>0.8.1-rc2 | javascript<br>0.4.0-alpha.103 | acapy-main<br>0.8.1-rc2 | acapy-main<br>0.8.1-rc2 | AIP 1.0 | [**38 / 39<br>97%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-aip10](#runset-acapy-aip10) | acapy-main<br>0.8.1-rc2 | acapy-main<br>0.8.1-rc2 | acapy-main<br>0.8.1-rc2 | acapy-main<br>0.8.1-rc2 | AIP 1.0 | [**35 / 35<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-aip10/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-aip20](#runset-acapy-aip20) | acapy-main<br>0.8.1-rc2 | acapy-main<br>0.8.1-rc2 | acapy-main<br>0.8.1-rc2 | acapy-main<br>0.8.1-rc2 | AIP 2.0 | [**60 / 61<br>98%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-aip20/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-ariesvcx](#runset-acapy-ariesvcx) | acapy-main<br>0.8.1-rc2 | aries-vcx<br>1.0.0 | acapy-main<br>0.8.1-rc2 | acapy-main<br>0.8.1-rc2 | AIP 1.0 | [**18 / 18<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-aries-vcx/reports/latest/index.html?redirect=false#behaviors) |
...
| [afgo-acapy](#runset-afgo-acapy) | afgo-interop<br>unknown | acapy-main<br>0.8.1-rc2 | afgo-interop<br>unknown | afgo-interop<br>unknown | pre-AIP 2.0 | [**1 / 17<br>5%**](https://allure.vonx.io/api/allure-docker-service/projects/afgo-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
| [afj-acapy](#runset-afj-acapy) | javascript<br>0.4.0-alpha.103 | acapy-main<br>0.8.1-rc2 | javascript<br>0.4.0-alpha.103 | javascript<br>0.4.0-alpha.103 | AIP 1.0 | [**11 / 28<br>39%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
| [ariesvcx-acapy](#runset-ariesvcx-acapy) | aries-vcx<br>1.0.0 | acapy-main<br>0.8.1-rc2 | aries-vcx<br>1.0.0 | aries-vcx<br>1.0.0 | AIP 1.0 | [**19 / 20<br>95%**](https://allure.vonx.io/api/allure-docker-service/projects/aries-vcx-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
...
*Last run: Wed Apr  5 00:22:59 UTC 2023*
```
...
*Last run: Wed Apr  5 00:47:57 UTC 2023*
```
...
*Last run: Wed Apr  5 00:35:12 UTC 2023*
```
...
*Last run: Wed Apr  5 00:49:37 UTC 2023*
```
...
*Last run: Wed Apr  5 01:29:06 UTC 2023*
```
...
*Last run: Wed Apr  5 01:04:51 UTC 2023*
```
...
*Last run: Wed Apr  5 01:20:30 UTC 2023*
```
...
*Last run: Wed Apr  5 02:31:25 UTC 2023*
```
