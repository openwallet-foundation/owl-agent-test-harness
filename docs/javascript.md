...
| ------ | :--------------: | :-------------: | :----------------: | :-----------------: | ----- | :-----: | 
| [acapy-afj](#runset-acapy-afj) | acapy-main<br>0.7.2-rc0 | javascript<br>atest | acapy-main<br>0.7.2-rc0 | acapy-main<br>0.7.2-rc0 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-dotnet-javascript](#runset-acapy-dotnet-javascript) | acapy-main<br>0.7.2-rc0 | javascript<br>atest | dotnet-master<br> | acapy-main<br>0.7.2-rc0 | AIP 1.0 | [**12 / 12<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-javascript-f-dotnet/reports/latest/index.html?redirect=false#behaviors) |
| [afj-acapy](#runset-afj-acapy) | javascript<br>atest | acapy-main<br>0.7.2-rc0 | javascript<br>atest | javascript<br>atest | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
| [afj-dotnet](#runset-afj-dotnet) | javascript<br>atest | dotnet-master<br> | javascript<br>atest | javascript<br>atest | AIP 1.0 | [**12 / 12<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-dotnet/reports/latest/index.html?redirect=false#behaviors) |
| [afj-findy](#runset-afj-findy) | javascript<br>atest | findy<br>0.25.13 | javascript<br>atest | javascript<br>atest | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-findy/reports/latest/index.html?redirect=false#behaviors) |
| [afj](#runset-afj) | javascript<br>atest | javascript<br>atest | javascript<br>atest | javascript<br>atest | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript/reports/latest/index.html?redirect=false#behaviors) |
| [dotnet-javascript](#runset-dotnet-javascript) | dotnet-master<br> | javascript<br>atest | dotnet-master<br> | dotnet-master<br> | AIP 1.0 | [**12 / 12<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/dotnet-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [findy-javascript-dotnet](#runset-findy-javascript-dotnet) | findy<br>0.25.13 | javascript<br>atest | dotnet-master<br> | findy<br>0.25.13 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-javascript-f-dotnet/reports/latest/index.html?redirect=false#behaviors) |
| [findy-javascript](#runset-findy-javascript) | findy<br>0.25.13 | javascript<br>atest | findy<br>0.25.13 | findy<br>0.25.13 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
...
*Last run: Wed Oct 27 01:31:31 UTC 2021*
```
...
*Last run: Wed Oct 27 01:42:47 UTC 2021*
```
...
*Last run: Wed Oct 27 01:57:29 UTC 2021*
```
...
*Last run: Wed Oct 27 01:55:50 UTC 2021*
```
...
*Last run: Wed Oct 27 02:25:39 UTC 2021*
```
...
*Last run: Wed Oct 27 02:10:10 UTC 2021*
```
...
*Last run: Wed Oct 27 02:22:49 UTC 2021*
```
...
*Last run: Wed Oct 27 01:46:21 UTC 2021*
```
...
*Last run: Wed Oct 27 02:20:10 UTC 2021*
```
