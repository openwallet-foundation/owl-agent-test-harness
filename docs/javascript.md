...
| [afj-dotnet](#runset-afj-dotnet) | javascript<br>0.3.3-alpha.0 | dotnet<br> | javascript<br>0.3.3-alpha.0 | javascript<br>0.3.3-alpha.0 | AIP 1.0 | [**12 / 12<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-dotnet/reports/latest/index.html?redirect=false#behaviors) |
| [afj-findy](#runset-afj-findy) | javascript<br>0.3.3-alpha.0 | findy<br>0.30.47 | javascript<br>0.3.3-alpha.0 | javascript<br>0.3.3-alpha.0 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-findy/reports/latest/index.html?redirect=false#behaviors) |
| [afj](#runset-afj) | javascript<br>0.3.3-alpha.0 | javascript<br>0.3.3-alpha.0 | javascript<br>0.3.3-alpha.0 | javascript<br>0.3.3-alpha.0 | AIP 1.0 | [**28 / 28<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript/reports/latest/index.html?redirect=false#behaviors) |
| [ariesvcx-javascript](#runset-ariesvcx-javascript) | aries-vcx<br>1.0.0 | javascript<br>0.3.3-alpha.0 | aries-vcx<br>1.0.0 | aries-vcx<br>1.0.0 | AIP 1.0 | [**0 / 20<br>0%**](https://allure.vonx.io/api/allure-docker-service/projects/aries-vcx-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [dotnet-javascript](#runset-dotnet-javascript) | dotnet<br> | javascript<br>0.3.3-alpha.0 | dotnet<br> | dotnet<br> | AIP 1.0 | [**12 / 12<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/dotnet-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [findy-javascript-dotnet](#runset-findy-javascript-dotnet) | findy<br>0.30.47 | javascript<br>0.3.3-alpha.0 | dotnet<br> | findy<br>0.30.47 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-javascript-f-dotnet/reports/latest/index.html?redirect=false#behaviors) |
| [findy-javascript](#runset-findy-javascript) | findy<br>0.30.47 | javascript<br>0.3.3-alpha.0 | findy<br>0.30.47 | findy<br>0.30.47 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [javascript-ariesvcx](#runset-javascript-ariesvcx) | javascript<br>0.3.3-alpha.0 | aries-vcx<br>1.0.0 | javascript<br>0.3.3-alpha.0 | javascript<br>0.3.3-alpha.0 | AIP 1.0 | [**5 / 18<br>27%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-aries-vcx/reports/latest/index.html?redirect=false#behaviors) |
...
*Last run: Tue Jan 10 01:42:43 UTC 2023*
```
...
*Last run: Tue Jan 10 01:55:29 UTC 2023*
```
...
*Last run: Tue Jan 10 01:59:43 UTC 2023*
```
...
*Last run: Tue Jan 10 02:39:19 UTC 2023*
```
...
*Last run: Tue Jan 10 02:43:18 UTC 2023*
```
...
*Last run: Tue Jan 10 03:06:07 UTC 2023*
```
...
*Last run: Tue Jan 10 03:02:10 UTC 2023*
```
...
*Last run: Tue Jan 10 03:36:47 UTC 2023*
```
