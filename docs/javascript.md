...
| ------ | :--------------: | :-------------: | :----------------: | :-----------------: | ----- | :-----: | 
| [acapy-afj](#runset-acapy-afj) | acapy-main<br>0.10.1 | javascript<br>0.4.1-alpha.56 | acapy-main<br>0.10.1 | acapy-main<br>0.10.1 | AIP 1.0 | [**32 / 39<br>82%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-dotnet-javascript](#runset-acapy-dotnet-javascript) | acapy-main<br>0.10.1 | javascript<br>0.4.1-alpha.56 | dotnet<br> | acapy-main<br>0.10.1 | AIP 1.0 | [**6 / 12<br>50%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-javascript-f-dotnet/reports/latest/index.html?redirect=false#behaviors) |
| [afj-acapy](#runset-afj-acapy) | javascript<br>0.4.1-alpha.56 | acapy-main<br>0.10.1 | javascript<br>0.4.1-alpha.56 | javascript<br>0.4.1-alpha.56 | AIP 1.0 | [**11 / 28<br>39%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
| [afj-dotnet](#runset-afj-dotnet) | javascript<br>0.4.1-alpha.56 | dotnet<br> | javascript<br>0.4.1-alpha.56 | javascript<br>0.4.1-alpha.56 | AIP 1.0 | [**0 / 12<br>0%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-dotnet/reports/latest/index.html?redirect=false#behaviors) |
...
| [afj](#runset-afj) | javascript<br>0.4.1-alpha.56 | javascript<br>0.4.1-alpha.56 | javascript<br>0.4.1-alpha.56 | javascript<br>0.4.1-alpha.56 | AIP 1.0 | [**12 / 28<br>42%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript/reports/latest/index.html?redirect=false#behaviors) |
| [ariesvcx-javascript](#runset-ariesvcx-javascript) | aries-vcx<br>1.0.0 | javascript<br>0.4.1-alpha.56 | aries-vcx<br>1.0.0 | aries-vcx<br>1.0.0 | AIP 1.0 | [**19 / 20<br>95%**](https://allure.vonx.io/api/allure-docker-service/projects/aries-vcx-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [dotnet-javascript](#runset-dotnet-javascript) | dotnet<br> | javascript<br>0.4.1-alpha.56 | dotnet<br> | dotnet<br> | AIP 1.0 | [**0 / 12<br>0%**](https://allure.vonx.io/api/allure-docker-service/projects/dotnet-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
...
*Last run: Mon Oct 30 00:45:58 UTC 2023*
```
...
*Last run: Mon Oct 30 00:50:52 UTC 2023*
```
...
*Last run: Mon Oct 30 01:28:03 UTC 2023*
```
...
*Last run: Mon Oct 30 01:34:12 UTC 2023*
```
...
*Last run: Mon Oct 30 01:38:42 UTC 2023*
```
...
*Last run: Mon Oct 30 01:50:12 UTC 2023*
```
...
*Last run: Mon Oct 30 02:28:01 UTC 2023*
```
...
*Last run: Mon Oct 30 02:13:41 UTC 2023*
```
...
*Last run: Mon Oct 30 02:36:14 UTC 2023*
```
...
*Last run: Mon Oct 30 02:44:49 UTC 2023*
```
...
*Last run: Mon Oct 30 03:28:40 UTC 2023*
```
