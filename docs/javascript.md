...
| ------ | :--------------: | :-------------: | :----------------: | :-----------------: | ----- | :-----: | 
| [acapy-afj](#runset-acapy-afj) | acapy-main<br>0.7.2-rc0 | javascript<br>0.1.0-alpha.301 | acapy-main<br>0.7.2-rc0 | acapy-main<br>0.7.2-rc0 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-dotnet-javascript](#runset-acapy-dotnet-javascript) | acapy-main<br>0.7.2-rc0 | javascript<br>0.1.0-alpha.301 | dotnet-master<br> | acapy-main<br>0.7.2-rc0 | AIP 1.0 | [**12 / 12<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-javascript-f-dotnet/reports/latest/index.html?redirect=false#behaviors) |
| [afj-acapy](#runset-afj-acapy) | javascript<br>0.1.0-alpha.301 | acapy-main<br>0.7.2-rc0 | javascript<br>0.1.0-alpha.301 | javascript<br>0.1.0-alpha.301 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
| [afj-dotnet](#runset-afj-dotnet) | javascript<br>0.1.0-alpha.301 | dotnet-master<br> | javascript<br>0.1.0-alpha.301 | javascript<br>0.1.0-alpha.301 | AIP 1.0 | [**11 / 12<br>91%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-dotnet/reports/latest/index.html?redirect=false#behaviors) |
| [afj-findy](#runset-afj-findy) | javascript<br>0.1.0-alpha.301 | findy<br>0.25.14 | javascript<br>0.1.0-alpha.301 | javascript<br>0.1.0-alpha.301 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-findy/reports/latest/index.html?redirect=false#behaviors) |
| [afj](#runset-afj) | javascript<br>0.1.0-alpha.301 | javascript<br>0.1.0-alpha.301 | javascript<br>0.1.0-alpha.301 | javascript<br>0.1.0-alpha.301 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript/reports/latest/index.html?redirect=false#behaviors) |
| [dotnet-javascript](#runset-dotnet-javascript) | dotnet-master<br> | javascript<br>0.1.0-alpha.301 | dotnet-master<br> | dotnet-master<br> | AIP 1.0 | [**12 / 12<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/dotnet-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [findy-javascript-dotnet](#runset-findy-javascript-dotnet) | findy<br>0.25.14 | javascript<br>0.1.0-alpha.301 | dotnet-master<br> | findy<br>0.25.14 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-javascript-f-dotnet/reports/latest/index.html?redirect=false#behaviors) |
| [findy-javascript](#runset-findy-javascript) | findy<br>0.25.14 | javascript<br>0.1.0-alpha.301 | findy<br>0.25.14 | findy<br>0.25.14 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
...
*Last run: Mon Nov  8 01:33:02 UTC 2021*
```
...
*Last run: Mon Nov  8 01:44:14 UTC 2021*
```
...
*Last run: Mon Nov  8 01:57:06 UTC 2021*
```
...
*Last run: Mon Nov  8 01:54:55 UTC 2021*
```
...
*Last run: Mon Nov  8 02:27:40 UTC 2021*
```
...
*Last run: Mon Nov  8 02:09:48 UTC 2021*
```
...
*Last run: Mon Nov  8 02:21:54 UTC 2021*
```
...
*Last run: Mon Nov  8 01:46:42 UTC 2021*
```
...
*Last run: Mon Nov  8 02:20:46 UTC 2021*
```
