...
| ------ | :--------------: | :-------------: | :----------------: | :-----------------: | ----- | :-----: | 
| [acapy-afj](#runset-acapy-afj) | acapy-main<br>1.0.0-rc0 | javascript<br>0.2.4-alpha.6 | acapy-main<br>1.0.0-rc0 | acapy-main<br>1.0.0-rc0 | AIP 1.0 | [**38 / 39<br>97%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [acapy-dotnet-javascript](#runset-acapy-dotnet-javascript) | acapy-main<br>1.0.0-rc0 | javascript<br>0.2.4-alpha.6 | dotnet<br> | acapy-main<br>1.0.0-rc0 | AIP 1.0 | [**12 / 12<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/acapy-b-javascript-f-dotnet/reports/latest/index.html?redirect=false#behaviors) |
| [afj-acapy](#runset-afj-acapy) | javascript<br>0.2.4-alpha.6 | acapy-main<br>1.0.0-rc0 | javascript<br>0.2.4-alpha.6 | javascript<br>0.2.4-alpha.6 | AIP 1.0 | [**27 / 28<br>96%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-acapy/reports/latest/index.html?redirect=false#behaviors) |
| [afj-dotnet](#runset-afj-dotnet) | javascript<br>0.2.4-alpha.6 | dotnet<br> | javascript<br>0.2.4-alpha.6 | javascript<br>0.2.4-alpha.6 | AIP 1.0 | [**12 / 12<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-dotnet/reports/latest/index.html?redirect=false#behaviors) |
| [afj-findy](#runset-afj-findy) | javascript<br>0.2.4-alpha.6 | findy<br>0.30.32 | javascript<br>0.2.4-alpha.6 | javascript<br>0.2.4-alpha.6 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-findy/reports/latest/index.html?redirect=false#behaviors) |
| [afj](#runset-afj) | javascript<br>0.2.4-alpha.6 | javascript<br>0.2.4-alpha.6 | javascript<br>0.2.4-alpha.6 | javascript<br>0.2.4-alpha.6 | AIP 1.0 | [**28 / 28<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript/reports/latest/index.html?redirect=false#behaviors) |
| [dotnet-javascript](#runset-dotnet-javascript) | dotnet<br> | javascript<br>0.2.4-alpha.6 | dotnet<br> | dotnet<br> | AIP 1.0 | [**12 / 12<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/dotnet-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [findy-javascript-dotnet](#runset-findy-javascript-dotnet) | findy<br>0.30.32 | javascript<br>0.2.4-alpha.6 | dotnet<br> | findy<br>0.30.32 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-javascript-f-dotnet/reports/latest/index.html?redirect=false#behaviors) |
| [findy-javascript](#runset-findy-javascript) | findy<br>0.30.32 | javascript<br>0.2.4-alpha.6 | findy<br>0.30.32 | findy<br>0.30.32 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
...
*Last run: Wed Sep 14 01:05:57 UTC 2022*
```
...
*Last run: Wed Sep 14 01:15:49 UTC 2022*
```
...
*Last run: Wed Sep 14 02:03:02 UTC 2022*
```
...
*Last run: Wed Sep 14 01:58:35 UTC 2022*
```
...
*Last run: Wed Sep 14 02:11:56 UTC 2022*
```
...
*Last run: Wed Sep 14 02:19:08 UTC 2022*
```
...
*Last run: Wed Sep 14 02:52:44 UTC 2022*
```
...
*Last run: Wed Sep 14 03:09:27 UTC 2022*
```
...
*Last run: Wed Sep 14 03:10:15 UTC 2022*
```
