...
| [afj-dotnet](#runset-afj-dotnet) | javascript<br>0.4.1-alpha.9 | dotnet<br> | javascript<br>0.4.1-alpha.9 | javascript<br>0.4.1-alpha.9 | AIP 1.0 | [**0 / 12<br>0%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-dotnet/reports/latest/index.html?redirect=false#behaviors) |
| [afj-findy](#runset-afj-findy) | javascript<br>0.4.1-alpha.9 | findy<br>0.31.11 | javascript<br>0.4.1-alpha.9 | javascript<br>0.4.1-alpha.9 | AIP 1.0 | [**2 / 17<br>11%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-findy/reports/latest/index.html?redirect=false#behaviors) |
| [afj](#runset-afj) | javascript<br>0.4.1-alpha.9 | javascript<br>0.4.1-alpha.9 | javascript<br>0.4.1-alpha.9 | javascript<br>0.4.1-alpha.9 | AIP 1.0 | [**12 / 28<br>42%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript/reports/latest/index.html?redirect=false#behaviors) |
| [ariesvcx-javascript](#runset-ariesvcx-javascript) | aries-vcx<br>1.0.0 | javascript<br>0.4.1-alpha.9 | aries-vcx<br>1.0.0 | aries-vcx<br>1.0.0 | AIP 1.0 | [**19 / 20<br>95%**](https://allure.vonx.io/api/allure-docker-service/projects/aries-vcx-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [dotnet-javascript](#runset-dotnet-javascript) | dotnet<br> | javascript<br>0.4.1-alpha.9 | dotnet<br> | dotnet<br> | AIP 1.0 | [**0 / 12<br>0%**](https://allure.vonx.io/api/allure-docker-service/projects/dotnet-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [findy-javascript-dotnet](#runset-findy-javascript-dotnet) | findy<br>0.31.11 | javascript<br>0.4.1-alpha.9 | dotnet<br> | findy<br>0.31.11 | AIP 1.0 | [**6 / 17<br>35%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-javascript-f-dotnet/reports/latest/index.html?redirect=false#behaviors) |
| [findy-javascript](#runset-findy-javascript) | findy<br>0.31.11 | javascript<br>0.4.1-alpha.9 | findy<br>0.31.11 | findy<br>0.31.11 | AIP 1.0 | [**17 / 17<br>100%**](https://allure.vonx.io/api/allure-docker-service/projects/findy-b-javascript/reports/latest/index.html?redirect=false#behaviors) |
| [javascript-ariesvcx](#runset-javascript-ariesvcx) | javascript<br>0.4.1-alpha.9 | aries-vcx<br>1.0.0 | javascript<br>0.4.1-alpha.9 | javascript<br>0.4.1-alpha.9 | AIP 1.0 | [**3 / 18<br>16%**](https://allure.vonx.io/api/allure-docker-service/projects/javascript-b-aries-vcx/reports/latest/index.html?redirect=false#behaviors) |
...
*Last run: Sat Jul 22 01:33:39 UTC 2023*
```
...
*Last run: Sat Jul 22 01:35:58 UTC 2023*
```
...
*Last run: Sat Jul 22 01:52:16 UTC 2023*
```
...
*Last run: Sat Jul 22 02:27:45 UTC 2023*
```
...
*Last run: Sat Jul 22 02:15:21 UTC 2023*
```
...
*Last run: Sat Jul 22 02:39:37 UTC 2023*
```
...
*Last run: Sat Jul 22 02:43:40 UTC 2023*
```
...
*Last run: Sat Jul 22 03:25:20 UTC 2023*
```
